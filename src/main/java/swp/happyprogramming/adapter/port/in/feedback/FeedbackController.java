...
public class FeedbackController {
  ...
  public String showUserFeedback(Model model,
    ...
    UserDTO viewedUser = userService.findUserDTO(userId);
    Pagination<Feedback> feedbacks = feedbackService.getFeedbackReceived(
      userService.getUserById(userId), pageNumber);
  ...
  public String createFeedback(Model model,
    ...
    UserDTO receivedUser = userService.findUserDTO(receivedId);
    List<Feedback> feedback = feedbackService.getFeedbackReceived(
      userService.getUserById((long) receivedId));
